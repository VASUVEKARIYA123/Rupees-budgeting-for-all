...
class GroupStatusBoard extends StatelessWidget {
  ...
  const GroupStatusBoard({Key? key, required this.group}) : super(key: key);
          ...
          Expanded(
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(text: settlement['from'], style: TextStyle(fontWeight: FontWeight.bold)),
                  TextSpan(text: ' pays '),
                  TextSpan(text: settlement['to'], style: TextStyle(fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          ),
